...
namespace MISHGANLABA1
{
    class Drobi
    {
        ...
        public string Zn { get; internal set; }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var result = drob1 + drob2;
            //Console.WriteLine($"Дробь: {result.Ch}/{result.}");
            Console.WriteLine((drob1 + drob2).Ch + "/" + (drob1 + drob2).Zn);
